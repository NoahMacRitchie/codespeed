...
void MainWindow::setStyles() {
    ...
    setStyleSheet("MainWindow{background-color: #232828;}" 
        "StyledTextZone, TypingZone{background-color: #1a1e1e; border: 1px solid #A5C9CA; border-radius: 5px; page-break-inside: avoid; line-height: 1.6; margin-bottom: 0.75em; padding: 0.5em 0.75em;}"
        "*{color: #E7F6F2}"
